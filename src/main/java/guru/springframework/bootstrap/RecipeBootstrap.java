...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    @Override
    // LEZIONE 167
    // EVITA STRANI PROBLEMI
    // DI INIZIALIZZAZIONE ANCHE SE NON
    // CI SONO EFFETTIVE TRANSAZIONI NEL
    // METODO getRecipe
    // IL PROBLEMA E' DOVUTO ALLA MODALITA
    // lazy=pigro CON CUI SONO INIZIALIZZATI
    // ALCUNI OGGETTI DA PARTE DI HIBERNATE
    // IN QUESTO MODO SI OTTIENE TUTTO
    // ALL'INTERNO DELLA STESSA TRANSAZIONE
    // DEFINENDO I CONFINI TRANSAZIONALI
    // DEL CONTESTO SOPRA QUESTO METODO
    @Transactional
